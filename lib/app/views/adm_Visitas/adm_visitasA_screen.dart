...
class AdmVisitasAScreen extends StatefulWidget {
  const AdmVisitasAScreen({super.key});

  @override
  State<AdmVisitasAScreen> createState() => _AdmVisitasScreenState();
//State<AdmMenu> createState() => _AdmMenuState();
}

class _AdmVisitasScreenState extends State<AdmVisitasAScreen> {
  ...
  Future<List<VisitaM6>> ? _futureVisitaM6;
            ...
            builder: (admComunicacionAdminController) => SingleChildScrollView(
                child: Column(
                    children: [
                                ...
                                child: Column(
                                    children: [
                                      ...
                                      * SizedBox(
                                      ...
                                      ), child: Text("Escanee QR",style: theme.textTheme.bodyMedium?.copyWith(
                                        fontWeight: FontWeight.bold,
                                        fontSize: MediaQuery.of(context).size.width*0.045,
                                        color: Colors.white,
                                      ),)),
                      ...
                      17.height,
            FutureBuilder<List<VisitaM6>>(
              future: _futureVisitaM6,
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isReceived = event.pvRecibida == 1;
                    final TextEditingController obsController =
                    TextEditingController(text: event.pvObservaciones ?? "");

                    return Card(
                      color: isReceived
                          ? const Color(0xFFDFFFE1) // light green
                          : const Color(0xFFFFF9E0), // light yellow
                      elevation: 3,
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        event.pvCodigo.toString(),
                                        style: const TextStyle(
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold,
                                          color: Color(0xFF064E74),
                                        ),
                                      ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      _infoText("Nombre de Visita:", event.pvVisitaNombre ?? ""),
                                      _infoText("Identificación de Visita:", event.pvVisitaNoIdentificacion ?? ""),
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      _infoText("Teléfono de Visita:", event.pvVisitaTelefono ?? ""),
                                      _infoText("Tipo de Entrada de Visita:", event.pvVisitaEntradaTipoDescripcion ?? ""),
                                      _infoText("Placa de Vehículo:", event.pvVisitaVehiculoPlaca ?? ""),
                                      _infoText("Observaciones:", event.pvObservaciones ?? ""),
                                    ],
                                  ),
                                ),
