  ...
  Future<List<Map<String, dynamic>>>listadoCreacionTickets()async
  {
    ...
    try
    {
      ...
      var url = Uri.parse(
        ...
        "$baseUrl/portal/tickets/gestion_creacion",
      );
  ...
  Future<List<Map<String, dynamic>>>listadoSeguimientoTickets()async
  {
    ...
    try
    {
      ...
      var url = Uri.parse(
        ...
        "$baseUrl/portal/tickets/seguimiento_gestion_creacion",
      );
      Map<String,dynamic> data =
      {
        "autenticacion": {
...
Future<List<Map<String, dynamic>>>GestionTickets2()async
{
  ...
  try
  {
    ...
    "$baseUrl/portal/tickets/gestion_tipo_listado");
    Map body = {
      "autenticacion":
      {
        "pv_token": token
  ...
  Future<List<Map<String, dynamic>>>listadoProcesoTickets()async
  {
    ...
    try
    {
      ...
      var url = Uri.parse(
        ...
        "$baseUrl/portal/tickets/gestion_en_proceso",
      );
      Map<String,dynamic> data =
      {
        "autenticacion": {
  ...
  Future<List<Map<String, dynamic>>>listadoFinalizarTickets()async
  {
    ...
    try
    {
      ...
      var url = Uri.parse(
        ...
        "$baseUrl/portal/tickets/gestion_finalizar",
      );
      Map<String,dynamic> data =
      {
        "autenticacion": {
